	...
	constructor(
		...
		this.plot = new Plot(null, {
			...
			plots: [
				...
				new Frame({ cssClasses: ['top-label'] }).area(() => this.plot?.topArea),
				new Frame({ cssClasses: ['bottom-label'] }).area(() => this.plot?.bottomArea),
				new Frame({ cssClasses: ['left-label'] }).area(() => this.plot?.leftArea),
				new Frame({ cssClasses: ['right-label'] }).area(() => this.plot?.rightArea),
				new Frame({ cssClasses: ['plot-area'] }).area(() => this.plot?.plotArea),
